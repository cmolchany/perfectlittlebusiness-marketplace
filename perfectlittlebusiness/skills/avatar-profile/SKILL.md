---
name: avatar-profile
description: Build your Avatar Emotional Profile — Step 1 of the Authority Directory Method. Use when the user wants to start, build, or work on their avatar / ideal-client profile, or says "avatar profile", "step 1", "let's start my Launchpad", "build my ideal client". Runs the live Avatar stage from Authority HQ.
---

# Avatar Emotional Profile — Launchpad Stage 1
...
4. **Save the output.** When the stage completes, save the finished output to the user's second brain as `brain/avatar-profile.md` (create the folder if needed). Tell the user where it's saved.
