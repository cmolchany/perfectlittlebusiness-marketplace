...
description: Build your Brand Style Guide, the fourth of the five foundational tools in your AIOS Brain. Use when the user wants to define their brand voice, tone, style, or visual identity, or says "brand style guide", "step 4", "my brand voice", "define my brand". Runs the live Brand Style Guide stage from Authority HQ.
---

# Brand Style Guide (AIOS Brain · Tool 4 of 5)
...
4. **Save the output.** When the stage completes, save the finished output to the user's AIOS Brain as `brain/brand-style-guide.md` (create the folder if needed). Tell the user where it's saved.
