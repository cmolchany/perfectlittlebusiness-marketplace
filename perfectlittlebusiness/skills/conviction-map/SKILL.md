---
name: conviction-map
description: Build your Conviction Map — Step 3 of the Authority Directory Method. Use when the user wants to map their convictions, beliefs, contrarian point of view, or what they stand for, or says "conviction map", "step 3", "map my beliefs", "my point of view". Runs the live Conviction Map stage from Authority HQ.
---

# Conviction Map — Launchpad Stage 3
...
4. **Save the output.** When the stage completes, save the finished output to the user's second brain as `brain/conviction-map.md` (create the folder if needed). Tell the user where it's saved.
